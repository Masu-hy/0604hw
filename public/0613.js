...
function setupFadeInAnimations() {
    const fadeElements = document.querySelectorAll(".fade-in-element, .fade-in-left, .fade-in-right, .fade-in-scale")
...
// 為動態添加的元素設置淡入動畫
function addFadeInToNewElements() {
    const newElements = document.querySelectorAll(".fade-in-element:not(.fade-in-visible)")
...
function setupEventListeners() {
    ...
    document.getElementById("priceForm").addEventListener("submit", (e) => {
        ...
        const form = e.target
        const newRecord = {
            year: Number.parseInt(form.year.value),
            month: Number.parseInt(form.month.value),
            date: Number.parseInt(form.date.value),
    ...
    document.getElementById("editForm").addEventListener("submit", (e) => {
        e.preventDefault()
        const form = e.target
        const id = Number.parseInt(form.querySelector('input[name="id"]').value)
        const updatedRecord = {
            id: id,
            year: Number.parseInt(form.year.value),
            month: Number.parseInt(form.month.value),
